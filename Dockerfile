...
# Install system dependencies (including Java for Allure) пошагово
RUN apt-get install -y curl wget git unzip gnupg openjdk-17-jre
RUN apt-get install -y libnss3 libatk-bridge2.0-0 libxss1 libasound2 libxshmfence1 libgtk-3-0 libgbm-dev libx11-xcb1 xvfb
